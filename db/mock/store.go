...
func (m *MockStore) AddAccountBallance(ctx context.Context, arg sqlc.AddAccountBallanceParams) (sqlc.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAccountBallance", ctx, arg)
...
func (mr *MockStoreMockRecorder) AddAccountBallance(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddAccountBallance", reflect.TypeOf((*MockStore)(nil).AddAccountBallance), ctx, arg)
}
...
func (m *MockStore) ListEntrys(ctx context.Context, arg sqlc.ListEntrysParams) ([]sqlc.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEntrys", ctx, arg)
	ret0, _ := ret[0].([]sqlc.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) ListEntrys(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEntrys", reflect.TypeOf((*MockStore)(nil).ListEntrys), ctx, arg)
}
